    ...
    for img_dir in image_list:
        ...
        for i, result in enumerate(results):
            ...
            cv2.putText(img_mat, str('%s:%0.2f' % ('p', pose_result[0,0])), 
                       (x_min - 78, y_min + 10), cv2.FONT_HERSHEY_COMPLEX , 0.5, (255,255,0), 2)
            cv2.putText(img_mat, str('%s:%0.2f' % ('r', pose_result[0,1])), 
                       (x_min - 78, y_min + 30), cv2.FONT_HERSHEY_COMPLEX , 0.5, (255,255,0), 2)
            cv2.putText(img_mat, str('%s:%0.2f' % ('y', pose_result[0,2])), 
                       (x_min - 78, y_min + 50), cv2.FONT_HERSHEY_COMPLEX , 0.5, (255,255,0), 2)
        ...
        cv2.imwrite('result_allinone_v1.jpg', img_mat)
