...
from Symbol_MobileFace_Identification_V2 import *
...
class MobileFaceFeatureExtractor(object):
    def __init__(self, model_file, epoch, batch_size, context = mxnet.cpu(), gpu_id = 0):
        ...
        network = get_feature_symbol_mobileface_v2() 
...
if __name__ == "__main__":
    model_file = '../MobileFace_Identification/MobileFace_Identification_V2'
    epoch = 0
    gpu_id = 0
    batch_size = 6
