...
from Symbol_MobileFace_Identification_V1 import *
...
class MobileFaceFeatureExtractor(object):
    def __init__(self, model_file, epoch, batch_size, context = mxnet.cpu(), gpu_id = 0):
        ...
        # self.model.bind(for_training = False, data_shapes=[('data', (self.batch_size, 1, 112, 112))])
    ...
    def get_face_feature_batch(self, face_batch):
        ...
        # batch_data = numpy.zeros((self.batch_size, 1, 112, 112))
